...
import com.algaworks.algafood.api.assembler.UsuarioInputSemSenhaDisassembler;
...
public class UsuarioController {
	...
	@Autowired
	UsuarioInputSemSenhaDisassembler usuarioInputSemSenhaDisassembler;
	
		
	@GetMapping("/{usuarioId}")
	public UsuarioModel busca (@PathVariable long usuarioId) {
	...
	public UsuarioModel atualizar(@PathVariable Long usuarioId,  @RequestBody @Valid UsuarioInputSemSenha usuarioInputSemSenha) {
		...
		usuarioInputSemSenhaDisassembler.copyToDomainObject(usuarioInputSemSenha, usuarioAtual);
